...
for t in data.get('tracks', []):
    ...
    for ev in t.get('events', []):
        ...
        if (start <= 42000 and end >= 40500) or (start <= 44500 and end >= 43000):
            print(f"Track #{t_idx} [{t_name}]: {ev.get('name')} | start={start/1000:.2f}s, end={end/1000:.2f}s | file={ev.get('media_path')}")
